...
regular_inventory AS (
    SELECT
        ...
        GETDATE() AS Today,
        a.item_desc,
        CAST(SUM(CASE WHEN b.location_id = '21' THEN (b.qty_on_hand - b.qty_allocated) ELSE 0 END) AS DECIMAL(18,2)) AS Birm,
        CAST(SUM(CASE WHEN b.location_id = '41' THEN (b.qty_on_hand - b.qty_allocated) ELSE 0 END) AS DECIMAL(18,2)) AS Dallas,
        CAST(SUM(CASE WHEN b.location_id = '51' THEN (b.qty_on_hand - b.qty_allocated) ELSE 0 END) AS DECIMAL(18,2)) AS Ocala,
